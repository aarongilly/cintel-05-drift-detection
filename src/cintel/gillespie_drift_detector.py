"""
gillespie_drift_detector.py - Project script (example).
...
Terminal command to run this file from the root project folder
    ...
    uv run python -m cintel.gillespie_drift_detector
"""
...
# Keepign the same reference file
REFERENCE_FILE: Final[Path] = DATA_DIR / "reference_metrics_case.csv"
CURRENT_FILE: Final[Path] = DATA_DIR / "current_metrics_case.csv"

OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_gillespie.csv"
SUMMARY_LONG_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_long_gillespie.csv"
...
REQUESTS_DRIFT_THRESHOLD: Final[float] = 100.0
